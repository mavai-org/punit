 ...
 * {@link org.mavai.punit.api.Contract} may carry one criterion (the
...
public interface Criterion<O> {
     ...
     * type implements {@link org.mavai.punit.api.Expected} and the
     ...
     * the expected value into {@link org.mavai.punit.api.Postcondition.Matching}
     * variants in their chain.
     *
     * @param value    the contract's produced output for this sample
     * @param expected the sample's known-correct output, present iff
     *                 the input implements {@link org.mavai.punit.api.Expected}
     * @return the criterion's per-sample evaluation record
     */
     ...
     * least one {@link org.mavai.punit.api.Postcondition.Matching}
     ...
     * {@link org.mavai.punit.api.Expected}. Hand-rolled
