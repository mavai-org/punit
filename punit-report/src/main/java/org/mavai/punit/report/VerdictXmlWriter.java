...
public final class VerdictXmlWriter {
    ...
    private void writePerCriterion(XMLStreamWriter w, ProbabilisticTestVerdict v)
        ...
        org.mavai.punit.verdict.PerCriterionStructure pc = v.perCriterion().get();
        w.writeStartElement("per-criterion");
        for (org.mavai.punit.verdict.CriterionRow row : pc.criteria()) {
            w.writeStartElement("criterion");
     ...
     */
    private static String mapTerminationReason(org.mavai.punit.verdict.TerminationReason reason) {
    ...
    private static String expirationStatusName(org.mavai.punit.verdict.ExpirationStatus status) {
        return switch (status) {
            case org.mavai.punit.verdict.ExpirationStatus.NoExpiration n -> "NO_EXPIRATION";
            case org.mavai.punit.verdict.ExpirationStatus.Valid v -> "VALID";
            case org.mavai.punit.verdict.ExpirationStatus.ExpiringSoon s -> "EXPIRING_SOON";
            case org.mavai.punit.verdict.ExpirationStatus.ExpiringImminently i -> "EXPIRING_IMMINENTLY";
            case org.mavai.punit.verdict.ExpirationStatus.Expired e -> "EXPIRED";
        };
    }
}
